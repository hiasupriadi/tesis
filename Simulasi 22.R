...
for(i in 1:iter){
  ...
  #Outlier: Jumlah: 4 Tipe Outlier: TC semua, Tidak Urut, T tertentu ----
  tipe.Out    = outliers(c("TC","TC","TC","TC"), c(50+10,50+20,50+30,50+40)) #50 adl data awal yg harus dihilangkan
